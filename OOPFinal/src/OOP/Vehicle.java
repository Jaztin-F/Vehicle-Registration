...
public class Vehicle extends Register {
    ...
    private String Bodynumber, Enginenumber, Bodycolor, Registrationdate, OwnerID, Type;
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (bn.equals(inputBN)) {
                    ...
                    System.out.printf("%-30s %-30s %-30s %-30s %-30s %-30s", "Body Number", "Engine Number", "Body Color", "Registration Date", "Owner's ID", "Vehicle Type");
                    System.out.println();
                    System.out.printf("%-30s %-30s %-30s %-30s %-30s %-30s", parts[0], parts[1], parts[2], parts[3], parts[4], parts[5]);
                    System.out.println();
                    System.out.println("====================================================================================================================================================================");
